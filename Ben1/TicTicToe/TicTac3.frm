...
Call Delay(1)
'
Call CheckUserWin(YesNo)
    If YesNo = 1 Then
        Call EndOfGame
        Exit Sub
    End If
'
Call CheckCompwin(YesNo)
    If YesNo = 1 Then
        Call EndOfGame
        Exit Sub
    End If
'
Call CheckBlock(MoveMade)
If MoveMade = 1 Then Exit Sub
Call FindSquare(MoveMade)
If MoveMade = 1 Then Exit Sub
Label10.Caption = "It's a draw!"
Call EndOfGame
End Sub
Private Sub CheckBlock(MoveMade)
MoveMade = 1 ' 0 means no block found, 1 means a block was found
...
MoveMade = 0
End Sub
Sub FindSquare(MoveMade)
MoveMade = 1  ' If the computer can make a move
...
ck5:
        ...
        Exit Sub
ck7:
        If Label1.Item(7).Caption <> Empty Then GoTo Draw
        Label1.Item(7).Caption = CompMark
        Exit Sub
Draw:
MoveMade = 0
End Sub
Private Sub CheckUserWin(YesNo)
uct = 0  ' number of user marks found
YesNo = 0
    For i = 0 To 2
    If Label1.Item(i).Caption = UserMark Then uct = uct + 1
...
End Sub
Private Sub CheckCompwin(YesNo)
uct = 0  ' number of user marks found
cct = 0  ' number of computer marks found
YesNo = 0
    For i = 0 To 2
