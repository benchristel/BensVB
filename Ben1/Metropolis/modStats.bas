...
Type Unit
    ...
    X As Single
    Y As Single
    Stats(0 To 11) As String
    Size As Integer
    Position As Integer '1 = N, 2 = E, 3 = S, 4 = W
    BaseType As Integer '1 = green
End Type
...
End Function
Public Function distance(X1 As Single, Y1 As Single, X2 As Single, Y2 As Single)
Dim xdiff, ydiff
xdiff = X1 - X2
ydiff = Y1 - Y2
...
Public Function RollDice(Dice As Integer, Sides As Integer, Add As Integer) As Integer
Dim i
For i = 1 To Dice
    RollDice = RollDice + Int(Rnd * Sides + Add)
Next i
End Function
