...
If WeaponData(Player(1).Weapon(1)).StartAmmo - WeaponData(Player(1).Weapon(1)).ClipSize >= 0 Then
    .Ammo(1) = WeaponData(Player(1).Weapon(1)).StartAmmo - WeaponData(Player(1).Weapon(1)).ClipSize
    .ClipAmmo(1) = WeaponData(Player(1).Weapon(1)).ClipSize
Else
    .Ammo(1) = 0
    .ClipAmmo(1) = WeaponData(Player(1).Weapon(1)).StartAmmo
End If
If WeaponData(Player(1).Weapon(2)).StartAmmo - WeaponData(Player(1).Weapon(2)).ClipSize >= 0 Then
    .Ammo(2) = WeaponData(Player(1).Weapon(2)).StartAmmo - WeaponData(Player(1).Weapon(2)).ClipSize
    .ClipAmmo(2) = WeaponData(Player(1).Weapon(2)).ClipSize
Else
    .Ammo(2) = 0
    .ClipAmmo(2) = WeaponData(Player(1).Weapon(2)).StartAmmo
End If
End With
With Player(2)
    .XCoord = 1680
    ...
    .Weapon(1) = StartWeapon(1)
    .Weapon(2) = StartWeapon(2)
If WeaponData(Player(2).Weapon(1)).StartAmmo - WeaponData(Player(2).Weapon(1)).ClipSize >= 0 Then
    .Ammo(1) = WeaponData(Player(2).Weapon(1)).StartAmmo - WeaponData(Player(2).Weapon(1)).ClipSize
    .ClipAmmo(1) = WeaponData(Player(2).Weapon(1)).ClipSize
Else
    .Ammo(1) = 0
    .ClipAmmo(1) = WeaponData(Player(2).Weapon(1)).StartAmmo
End If
If WeaponData(Player(2).Weapon(2)).StartAmmo - WeaponData(Player(2).Weapon(2)).ClipSize >= 0 Then
    .Ammo(2) = WeaponData(Player(2).Weapon(2)).StartAmmo - WeaponData(Player(2).Weapon(2)).ClipSize
    .ClipAmmo(2) = WeaponData(Player(2).Weapon(2)).ClipSize
Else
    .Ammo(2) = 0
    .ClipAmmo(2) = WeaponData(Player(2).Weapon(2)).StartAmmo
End If
End With
End Sub
