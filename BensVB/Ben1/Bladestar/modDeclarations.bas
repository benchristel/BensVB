...
Type PlayerRecord 'tournament use
    ...
    Losses As Integer
End Type
Public ObjectGraphicsDC(1 To 1) As Long, PlayerGraphicsDC(1 To 2) As Long, WeaponGraphicsDC(1 To 9) As Long, ShotGraphicsDC(1 To 5) As Long
...
Public PlayerMaskDC(1 To 2) As Long, BackBuffDC(1 To 2) As Long, BackgroundDC As Long, WeaponMaskDC(1 To 9) As Long, SightDC As Long, SightMaskDC As Long, ShotMaskDC(1 To 5) As Long
...
Public RuleVariant As Integer, VariantWeapon(1 To 11) As Integer, MapSelected As Integer
